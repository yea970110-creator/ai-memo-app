...
export default function MemoItem({
  ...
  return (
    ...
    >
      ...
      {/* 내용: 요약이 있으면 요약, 없으면 본문 미리보기 */}
      <div className="mb-4 line-clamp-3 overflow-hidden memo-card-preview">
        {memo.summary ? (
          <div className="flex items-start gap-2">
            <span className="shrink-0 mt-0.5 w-1 h-1 rounded-full bg-purple-500" />
            <MarkdownPreview
              source={memo.summary}
